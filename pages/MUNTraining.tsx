...
const trainingAreas = [
    {
        ...
        desc: "A comprehensive overview of the United Nations - its aims, objectives, components and functions to acquaint students with the fundamentals of the MUN.",
        icon: FiGlobe,
        color: "bg-white",
    ...
    },
    {
        ...
        desc: "Thorough grounding in one of the most essential aspects of MUNs - speech writing and delivery, with an emphasis on tonality, body language, content presentation and improvisation.",
        icon: FiUser,
        color: "bg-white",
        iconBorder: "border-yellow-100 shadow-[0_0_20px_rgba(255,215,0,0.15)]"
    },
    ...
    {
        title: "Mock MUNs",
        desc: "Mock MUN simulations and drills to get hands-on experience of the MUN setup, along with real-time guidance and precise feedback to translate training into tangible learning.",
        icon: FiMonitor,
        color: "bg-white",
        iconBorder: "border-yellow-100 shadow-[0_0_20px_rgba(255,215,0,0.15)]"
    }
...
const faqs = [
    {
        ...
        answer: "Model United Nations, also known as Model UN or MUN, is an extra-curricular activity in which students typically role-play delegates to the United Nations and simulate UN committees."
    },
    {
    ...
    },
    {
        ...
        answer: "Yes, our program starts from MUN Fundamentals and gradually builds up to advanced topics like Resolution Drafting and Chairing, making it perfect for both beginners and experienced delegates."
    },
    {
        question: "Do you provide mock simulations?",
        answer: "Absolutely! Mock MUNs are a core part of our training, providing hands-on experience and real-time feedback."
    }
];
        ...
        <div className="min-h-screen bg-white font-sans">
            ...
            <section id="about" className="py-20 px-6 max-w-5xl mx-auto text-center">
                ...
                <p className="text-[15px] text-gray-500 leading-relaxed max-w-4xl mx-auto px-4 md:px-0">
                    ...
                    With our dedicated MUN training program, students can develop all the skills they need to excel in this domain.
                </p>
                    ...
                    <div className="w-full md:w-[60%] space-y-8">
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="flex justify-center pt-4">
                                <button
                                    type="submit"
                                    className="bg-[#8c5a31] text-white px-12 py-2 rounded text-sm font-bold shadow-lg hover:brightness-110 transition-all"
                                >
                                    Submit
                                </button>
                            </div>
